...
class UsersRoleFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'role_name' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_0900_ai_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_at' => 1683753199,
                'updated_at' => 1683753199,
            ],
        ];
        parent::init();
    }
