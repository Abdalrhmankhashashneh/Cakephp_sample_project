        ...
        <div class="row align-items-center flex-wrap-reverse h-100">
          ...
          <div class="col-md-6 py-5 wow zoomIn">
            <div class="img-fluid text-center">
                <?= $this->Html->image('../Website/assets/img/banner_image_1.svg') ?>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="card-service wow fadeInUp">
            <div class="header">
                <?= $this->Html->image('../Website/assets/img/services/service-1.svg') ?>
            </div>
            <div class="body">
        ...
        <div class="col-lg-4">
          <div class="card-service wow fadeInUp">
            <div class="header">
            <?= $this->Html->image('../Website/assets/img/services/service-2.svg') ?>
        ...
        <div class="col-lg-4">
          <div class="card-service wow fadeInUp">
            <div class="header">
            <?= $this->Html->image('../Website/assets/img/services/service-3.svg') ?>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 py-3 wow fadeInRight">
          <div class="img-fluid py-3 text-center">
               <?= $this->Html->image('../Website/assets/img/about_frame.png') ?>
          </div>
        </div>
      </div>
    </div> <!-- .container -->
    ...
    <div class="wrap bg-image" style="background-image: url(../assets/img/bg_pattern.svg);">
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-6 py-3 wow fadeInRight">
            <div class="img-fluid text-center">
            <?= $this->Html->image('../Website/assets/img/banner_image_2.svg') ?>
      ...
      <div class="row mt-5">
          ...
          <div class="card-blog">
            <div class="header">
              <div class="post-thumb">
                <?= $this->Html->image('../Website/assets/img/blog/blog-1.jpg') ?>
              </div>
            </div>
            <div class="body">
        ...
        <div class="col-lg-4 py-3 wow fadeInUp">
          <div class="card-blog">
            <div class="header">
              <div class="post-thumb">
              <?= $this->Html->image('../Website/assets/img/blog/blog-2.jpg') ?>
              </div>
            </div>
            <div class="body">
              <h5 class="post-title"><a href="#">Source of Content Inspiration</a></h5>
        ...
        <div class="col-lg-4 py-3 wow fadeInUp">
          <div class="card-blog">
            <div class="header">
              <div class="post-thumb">
              <?= $this->Html->image('../Website/assets/img/blog/blog-3.jpg') ?>
              </div>
            </div>
            <div class="body">
              <h5 class="post-title"><a href="#">Source of Content Inspiration</a></h5>
